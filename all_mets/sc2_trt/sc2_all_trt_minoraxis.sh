...
### sc2_all_trt_minoraxis.sh   ### <---------- Change me
###########################################################################
## environment & variable setup
####### job customization
#SBATCH --job-name="sc2_all_trt_minoraxis"   ### <---------- Change me
#SBATCH -N 3
#SBATCH -n 16
#SBATCH -t 10:00:00
#SBATCH -p normal_q
...
cat sc2_all_trt_minoraxis.sh  ### <---------- Change me
###########################################################################
echo start running R
## note, on DT/CA, you should replace projects with groups

singularity exec --bind=/work,/projects \
    /projects/arcsingularity/ood-rstudio141717-bio_4.1.0.sif Rscript sc2_all_trt_minoraxis.R   ### <---------- Change me
