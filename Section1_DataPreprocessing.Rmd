...
```{r, eval=F}
met <- read.delim("~/Library/CloudStorage/OneDrive-VirginiaTech/Research/Codes/research/RiceUNLMetabolites/Pheno/raw_data/211024_HNT_seed_metabolites.txt")
met = met[,c(14,7,10,11,19:91)] # "NSFTV.Id"  "Treatment" "Ext.batch" "Run" and 73 Metabolites
...
###########################
###Remove one genotype
majoraxis <- read.csv("../raw_data/data_all_C_MajorAxisLength_mean.csv")
minoraxis <- read.csv("../raw_data/data_all_C_MinorAxisLength_mean.csv")
...
perimeter <- read.csv("../raw_data/data_all_C_Perimeter_mean.csv")
